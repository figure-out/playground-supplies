  ...
  >
    ...
    <span>
      <input
        ...
        step="any"
        min="0"
        class="ladder-parameters__number-input"
      />
      metres
    </span>
  </div>
  <br />
  <div>Ladder price: {{ formatCurrency(ladderPrice) }}</div>
  <button @click="handleAddClick" type="button" class="ladder-parameters__button">
    <img src="/icons/plus-round-icon.svg" alt="Add to cart" class="ladder-parameters__icon" />
    Add to Cart
  </button>
</template>
